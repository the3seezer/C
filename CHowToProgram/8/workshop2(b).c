/*
    ...
    weight               // ounce = 28.35 grams, ton = 1016.04 kilograms NOTE: Find a precise convertor 
    British capacity     // pint = 0.568 liter, gallon = 4.546 liters : Find a precise convertor
    American Capacity    // us pint = 0.473 liter, us gallon = 3.785 liters : Find a precise convertor
    Capacity             // centiliter = 0.018 pint / 0.021 US pint, liter = 1.76 pints / 2.1 US pints : Find a precise convertor 
*/
#include <stdio.h>
#include <string.h>
#include <ctype.h>
...
int main( void ) {
    ...
    char request[100] = "How many 1000 cubic centimeters are in liter?"; // question/ request input by user
    char *unitPtr = "";
    char *unit1 = "";  // unit one
    char *unit2 = "";  // unit two
